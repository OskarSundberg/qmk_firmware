...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [1] = LAYOUT(SE_EXLM     , SE_AT       , SE_LCBR     ,SE_RCBR      , SE_PIPE  ,            SE_MINS    , KC_7        , KC_8     , KC_9     , SE_SLSH     ,
                      ...
                      SE_LABK     , SE_RABK     , SE_LBRC     ,SE_RBRC      , SE_AMPR  ,            SE_ASTR    , KC_1        , KC_2     , KC_3     , SE_EQL      ,
                                                                MO(_sym2)   , KC_TAB   ,            _______     , _______),
        ...
        [3] = LAYOUT(_______    , _______     , _______     , _______     , _______  ,              _______    , SE_ARNG     , _______     , _______     , _______     ,
                       _______    , _______     , _______     , KC_SCLN     , _______  ,            SE_ODIA    , SE_ADIA     , KC_UP       , _______     , _______     ,
                       _______    , _______     , _______     , _______     , _______  ,            _______    , KC_LEFT     , KC_DOWN     , KC_RIGHT    , _______     ,
                                                                KC_LALT     , KC_ESC   ,            KC_TAB     , _______)
                                                            
};

//C(A(KC_DEL)) == CTRL ALT DELETE
